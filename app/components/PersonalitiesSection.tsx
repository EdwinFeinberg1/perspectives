...
>(({ selectedModels, setSelectedModels }, ref) => {
  ...
  return (
    <section
      ref={ref}
      className="mt-10 px-[7%] bg-gradient-to-b from-transparent to-black/30 mb-10 max-h-[calc(100vh-200px)] overflow-y-auto scrollbar-hide"
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <CardHeader className="text-[#ddc39a] flex flex-row items-center gap-2 pt-1 pb-0">
            <span className="text-lg">✡️</span>
            <span className="text-base font-medium">RabbiGPT</span>
          </CardHeader>
          <CardContent className="pt-2 pb-4">
            <p className="text-xs text-[#ddc39a]/70 leading-snug">
